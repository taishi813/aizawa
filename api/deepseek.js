...

{
  ...
  "location": "神田明神",
  "event": "散歩",
  "summary": "大志と神田明神を訪れた。境内を歩きながら、東京の歴史や平将門について話した。"
}

という形になる。

そして検索も、「誰と」だけではなく「どこで」「何をした」「何について話した」まで見る。

たとえば大志が、

「そういや神田明神に行ったとき、将門の話したよな」
...
あたりが検索に引っかかって、その歴史が上位に出てくる。

逆に100件ある歴史のうち今回関係ない90件はDeepSeekには送られない。

**「世界全体の記憶は共有しているが、その場で思い出すのは必要な記憶だけ」**という構造になる。これは今回作っているキャラクターシステムにはかなり相性がいい。